...
public class PreparedStatements {
    ...
    public static final String URLS_CHECK_INSERT =
            "INSERT INTO url_checks (url_id, status_code, h1, title, description, created_at) "
                    + "VALUES (?, ?, ?, ?, ?, ?)";
    public static final String URLS_CHECK_SELECT_BY_URL_ID =
            "SELECT * FROM url_checks WHERE url_id = ? ORDER BY id DESC";
    public static final String URLS_CHECK_SELECT_DISTINCT_BY_URL_ID =
